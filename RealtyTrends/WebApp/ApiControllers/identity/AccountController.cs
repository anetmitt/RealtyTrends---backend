...
public class AccountController : ControllerBase
{
        ...
        int expiresInSeconds)
    {
        ...
        var jwt = IdentityHelpers.GenerateJwt(
            ...
            expiresInSeconds < _configuration.GetValue<int>("JWT:AccessTokenExpiration")
                ? expiresInSeconds
                : _configuration.GetValue<int>("JWT:AccessTokenExpiration")
        );
    ...
    /// </summary>
    /// <param name="loginData">input data about your account</param>
    ...
    public async Task<ActionResult<JwtResponse>> LogIn([FromBody] Login loginData, [FromQuery] int expiresInSeconds)
    {
        ...
        foreach (var userRefreshToken in appUser.AppRefreshTokens)
        {
            if (
                ...
                (
                    userRefreshToken.PreviousExpiration == null ||
                    userRefreshToken.PreviousExpiration < DateTime.UtcNow
                )
            )
            {
